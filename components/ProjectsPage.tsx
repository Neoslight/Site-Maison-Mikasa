...
const ProjectsPage: React.FC<ProjectsPageProps> = ({ initialType = 'Tous' }) => {
  ...
  const getTitle = () => {
    switch(filter) {
      case 'Maison': return 'Nos Maisons';
      case 'Appartement': return 'Nos Appartements';
      case 'Professionnel': return 'Espaces Professionnels';
      default: return 'Toutes nos Réalisations';
    }
  };
    ...
    <div className="bg-white min-h-screen">
      ...
      <Section bgColor="bg-stone-50" className="text-center" py="py-24">
        <div className="max-w-4xl mx-auto px-6">
          <span className="text-sage-600 uppercase tracking-widest text-xs font-bold mb-4 block">Portfolio</span>
          ...
          <p className="text-stone-600 font-light max-w-2xl mx-auto">
            Découvrez une sélection de projets d'architecture et de décoration d'intérieur. Chaque lieu raconte une histoire unique, la vôtre.
          </p>
        </div>
      </Section>
