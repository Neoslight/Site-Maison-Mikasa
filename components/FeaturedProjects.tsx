    ...
    <Section id="featured-projects" className="max-w-7xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {featured.map((project) => (
          <a href={`#project-${project.id}`} key={project.id} className="group block cursor-pointer">
      ...
      <div className="mt-12 text-center">
        <a href="#realisations" className="inline-block border-b border-stone-800 pb-1 text-sm uppercase tracking-widest text-stone-800 hover:text-sage-600 hover:border-sage-600 transition-colors">
